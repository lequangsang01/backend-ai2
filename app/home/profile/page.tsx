...
const Profile = () => {
  ...
  const [msSuccess, setMsSuccess] = useState<any>(null);
  ...
  const handleSubmit = async (e: { preventDefault: () => void; }) => {
    ...
    try {
      ...
      if(response.data){
        setMsSuccess('Changed password successfully')
        setTimeout(() => {
          setMsSuccess(null);
        }, 3000);
      }
              ...
              <div className="p-7">
                <form action="#">
                  ...
                  <div className="mb-5.5">
                    ...
                    <input
                      ...
                      name="Username"
                      id="Username"
                      value={dataUser ? dataUser.parent_id: ''}
                    />
                  </div>
                ...
                <div className="mb-6">
                  ...
                  <div>
                    ...
                    { msSuccess !== null &&(<p style={{color:'green'}}>{msSuccess}</p>)}
                  </div>
                </div>
